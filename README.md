...
![日历图片](https://github.com/spock504/wx_components/blob/master/image/calendarImg.png)   
### 使用说明  
``` javascript
...
![优惠券图片](https://github.com/spock504/wx_components/blob/master/image/couponImg.png) 
### 使用说明  
``` javascript
...
![底部弹窗图](https://github.com/spock504/wx_components/blob/master/image/btmModelImg.png) 
### 使用说明  
``` javascript
